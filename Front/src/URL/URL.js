export const URL = {
  ...
  USER_GET_BYID: "http://localhost:3001/user/:id",
  ...
  USER_DELETE: "http://localhost:3001/user/:id",
  USER_UPDATE: "http://localhost:3001/user/:id",
  ...
  POST_GET_ONE_BYID: "http://localhost:3001/post/:id",
  POST_DELETE: "http://localhost:3001/post/:id",
  POST_UPDATE: "http://localhost:3001/post/:id",
  ...
  CATEGORY_GET_ONE_BYID: "http://localhost:3001/category/:id",
  CATEGORY_DELETE: "http://localhost:3001/category/:id",
  CATEGORY_UPDATE: "http://localhost:3001/category/:id",
  ...
  PRODUCT_GET_ONE_BYID: "http://localhost:3001/product/:id",
  PRODUCT_DELETE: "http://localhost:3001/product/:id",
  PRODUCT_UPDATE: "http://localhost:3001/product/:id",
